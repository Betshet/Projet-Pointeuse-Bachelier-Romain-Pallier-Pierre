...
public class OngletManagers extends JPanel implements ActionListener 
{
	...
	public OngletManagers(Controller controller)
	{
		setControl(controller);
		
		setModel( new DefaultTableModel(getControl().getCompany().getAllManager(),nomColonnes) );
